	...
	// TODO: all the global variables in this file references US addresses... this should all be in the unified map and just extern in this file
...
static const Controller* Controllers = (Controller*)0x80400d50; // JP (mPadStatus__10JUTGamePad)
static const Controller* ControllerOne = (Controller*)0x80400d50; // JP
...
static HitActor** gpMarioAddress = (void*)0x8040a398; // JP
...
static float** gpMarioSpeedY = (void*)0x8040a3b0; // JP
...
unsigned int VIGetRetraceCount(void);
