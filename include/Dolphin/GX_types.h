...
#define GX_FIFO_MINSIZE                                                                            \
    (64 * 1024)                         /*!< Smallest usable graphics FIFO size.                   \
                                         */
 ...
 *
 * \note Which type you use depends on your needs; however, performance can
 * increase by using triangle strips or fans instead of discrete triangles.
 * @{
 */
#define GX_POINTS 0xB8 /*!< Draws a series of points. Each vertex is a single point. */
#define GX_LINES                                                                                   \
    0xA8 /*!< Draws a series of unconnected line segments. Each pair of vertices                   \
            makes a line. */
#define GX_LINESTRIP                                                                               \
    0xB0 /*!< Draws a series of lines. Each vertex (besides the first) makes a                     \
            line between it and the previous. */
#define GX_TRIANGLES                                                                               \
    0x90 /*!< Draws a series of unconnected triangles. Three vertices make a                       \
            single triangle. */
#define GX_TRIANGLESTRIP                                                                           \
    0x98 /*!< Draws a series of triangles. Each triangle (besides the first)                       \
          * shares a side with the previous triangle. Each vertex (besides the                     \
          * first two) completes a triangle. */
#define GX_TRIANGLEFAN                                                                             \
    0xA0 /*!< Draws a single triangle fan. The first vertex is the                                 \
          * "centerpoint". The second and third vertex complete the first                          \
          * triangle. Each subsequent vertex completes another triangle which                      \
          * shares a side with the previous                                                        \
          * triangle (except the first triangle) and has the centerpoint vertex                    \
          * as one of the vertices. */
#define GX_QUADS                                                                                   \
    0x80 /*!< Draws a series of unconnected quads. Every four vertices completes                   \
          * a quad. Internally, each quad is translated into a pair of                             \
          * triangles. */
/*! @} */
 ...
 */
#define GX_TG_MTX3x4                                                                               \
    0 /*!< 3x4 matrix multiply on the input attribute and generate S,T,Q                           \
       * coordinates; S,T are then divided                                                         \
       * by Q to produce the actual 2D texture coordinates. */
#define GX_TG_MTX2x4                                                                               \
    1                 /*!< 2x4 matrix multiply on the input attribute and generate S,T texture     \
                         coordinates. */
...
#define GX_TG_SRTG                                                                                 \
    10 /*!< Coordinates generated from vertex lighting results; one of the color                   \
        * channel results is converted into texture coordinates. */
/*! @} */
 ...
 * \details Each pixel (source or destination) is multiplied by any of these
 * controls.
 * @{
 */
 ...
 * \details Destination (dst) acquires the value of one of these operations,
 * given in C syntax.
 * @{
 */
 ...
 *
 * \details For these equations, <i>Cv</i> is the output color for the stage,
 * <i>Cr</i> is the output color of previous stage, and <i>Ct</i> is the texture
 * color. <i>Av</i> is the output alpha for a stage, <i>Ar</i> is the output
 * alpha of previous stage, and <i>At</i> is the texture alpha. As a special
 * case, rasterized color
 * (<tt>GX_CC_RASC</tt>) is used as <i>Cr</i> and rasterized alpha
 * (<tt>GX_CA_RASA</tt>) is used as <i>Ar</i> at the first TEV stage because
...
#define GX_DECAL                                                                                   \
    1                /*!< <i>Cv</i>=(1-<i>At</i>)<i>Cr</i> + <i>AtCt</i>; <i>Av</i>=<i>Ar</i>      \
                      */
...
#define GX_CC_C0                                                                                   \
    2 /*!< Use the color value from the color/output register 0                                    \
       */
#define GX_CC_A0                                                                                   \
    3 /*!< Use the alpha value from the color/output register 0                                    \
       */
#define GX_CC_C1                                                                                   \
    4 /*!< Use the color value from the color/output register 1                                    \
       */
#define GX_CC_A1                                                                                   \
    5 /*!< Use the alpha value from the color/output register 1                                    \
       */
#define GX_CC_C2                                                                                   \
    6 /*!< Use the color value from the color/output register 2                                    \
       */
#define GX_CC_A2                                                                                   \
    7                  /*!< Use the alpha value from the color/output register 2                   \
                        */
...
#define GX_CA_A0                                                                                   \
    1 /*!< Use the alpha value from the color/output register 0                                    \
       */
#define GX_CA_A1                                                                                   \
    2 /*!< Use the alpha value from the color/output register 1                                    \
       */
#define GX_CA_A2                                                                                   \
    3                 /*!< Use the alpha value from the color/output register 2                    \
                       */
 ...
 * \details The GameCube's Graphics Processor (GP) can use up to 16 stages to
 * compute a texel for a particular surface. By default, each texture will use
 * two stages, but it can be configured through various functions calls.
 *
 ...
 * \note These modes are used for a function which is not implementable on
 * production (i.e. retail) GameCube hardware.
 * @{
 */
 ...
 *
 * \details The GameCube's Graphics Processor (GP) can apply up to eight
 * textures to a single surface. Those textures are assigned one of these slots.
 * Various operations used on or with a particular texture will also take one of
 * these items, including operations regarding texture coordinate generation
 * (although not necessarily on the same slot).
 *
 * \note This is different from \ref tevstage s, which are the actual quanta for
 * work with textures.
 * @{
 */
...
typedef enum _GXTevKColorID {
    GX_KCOLOR0, /*!< Constant register 0 */
    GX_KCOLOR1, /*!< Constant register 1 */
    GX_KCOLOR2, /*!< Constant register 2 */
    GX_KCOLOR3, /*!< Constant register 3 */
    GX_MAX_KCOLOR
} GXTevKColorID;
/*! @} */
 ...
 * \details Bits for the indirect offsets are extracted from the high end of
 * each component byte. Bits for the bump alpha are extraced off the low end of
 * the byte. For <tt>GX_ITF_8</tt>, the byte is duplicated for the offset and
 * the bump alpha.
 * @{
 */
#define GX_ITF_8        0
 ...
 * \brief Indicates which components of the indirect offset should receive a
 * bias value.
 *
 * \details The bias is fixed at -128 for <tt>GX_ITF_8</tt> and +1 for the other
 * formats. The bias happens prior to the indirect matrix multiply.
 * @{
 */
...
#define GX_ITM_T1                                                                                  \
    10 /*!< Specifies dynamic T-type matrix, indirect scale 1.                                     \
        */
#define GX_ITM_T2                                                                                  \
    11 /*!< Specifies dynamic T-type matrix, indirect scale 2.                                     \
        */
/*! @} */

/*! \addtogroup indtexwrap Indirect texture wrap value
 * \brief Indicates whether the regular texture coordinate should be wrapped
 * before being added to the offset.
 *
 * \details <tt>GX_ITW_OFF</tt> specifies no wrapping. <tt>GX_ITW_0</tt> will
 * zero out the regular texture coordinate.
 * @{
 */
#define GX_ITW_OFF    0
#define GX_ITW_256    1
 ...
 * \brief Indicates which offset component should provide the "bump" alpha
 * output for the given TEV stage.
 *
 ...
 * \brief Specifies an additional scale value that may be applied to the
 * texcoord used for an indirect initial lookup (not a TEV stage regular
 * lookup).
 *
 * \details The scale value is a fraction; thus <tt>GX_ITS_32</tt> means to
 * divide the texture coordinate values by 32.
 * @{
 */
#define GX_ITS_1       0
#define GX_ITS_2       1
 ...
 * \brief Controls whether all lines, only even lines, or only odd lines are
 * copied from the EFB.
 * @{
 */
 ...
 * \details Performance counter 0 is used to measure attributes dealing with
 * geometry and primitives, such as triangle counts and clipping ratios.
 *
 * \note <tt>GX_PERF0_XF_*</tt> measure how many GP cycles are spent in each
 * stage of the XF.<br><br>
 *
 * \note The triangle metrics (<tt>GX_PERF0_TRIANGLES_*</tt>) allow counting
 * triangles under specific conditions or with specific attributes.<br><br>
 *
 * \note <tt>GX_PERF0_TRIANGLES_*TEX</tt> count triangles based on the number of
 * texture coordinates supplied; <tt>GX_PERF0_TRIANGLES_*CLR</tt> count
 * triangles based on the number of colors supplied.<br><br>
 *
 * \note The quad metrics allow you to count the number of quads (2x2 pixels)
 * the GP processes. The term <i>coverage</i> is used to indicate how many
 * pixels in the quad are actually part of the triangle being rasterized. For
 * example, a coverage of 4 means all pixels in the quad intersect the triangle.
 * A coverage of 1 indicates that only 1 pixel in the quad intersected the
 * triangle.
 * @{
 */
...
#define GX_PERF0_XF_WAIT_IN                                                                        \
    3 /*!< Number of cycles the XF is waiting on input. If the XF is waiting a                     \
...
#define GX_PERF0_XF_WAIT_OUT                                                                       \
    4 /*!< Number of cycles the XF waits to send its output to the rest of the                     \
       * GP pipeline. If the XF cannot output, it may indicate that the GP is                      \
...
#define GX_PERF0_TRIANGLES_CULLED                                                                  \
    12 /*!< Number of triangles that <i>failed</i> the front-face/back-face                        \
          culling test. */
#define GX_PERF0_TRIANGLES_PASSED                                                                  \
    13 /*!< Number of triangles that <i>passed</i> the front-face/back-face                        \
          culling test. */
...
#define GX_PERF0_CLOCKS                                                                            \
    34 /*!< Number of GP clocks that have elapsed since the previous call to                       \
          GXReadGP0Metric(). */
 ...
 * \details Performance counter 1 is used for measuring texturing and caching
 * performance as well as FIFO performance.
 *
 * \note <tt>GX_PERF1_TC_*</tt> can be used to compute the texture cache (TC)
 * miss rate. The <tt>TC_CHECK*</tt> parameters count how many texture cache
 * lines are accessed for each pixel. In the worst case, for a mipmap, up to 8
 * cache lines may be accessed to produce one textured pixel.
 * <tt>GX_PERF1_TC_MISS</tt> counts how many of those accesses missed the
 * texture cache. To compute the miss rate, divide <tt>GX_PERF1_TC_MISS</tt> by
 * the sum of all four <tt>GX_PERF1_TC_CHECK*</tt> values.<br><br>
 *
...
#define GX_PERF1_VC_MISS_REQ                                                                       \
    19 /*!< Number vertex cache miss request. Each miss requests a 32B transfer                    \
          from main memory. */
#define GX_PERF1_CP_ALL_REQ                                                                        \
    20 /*!< Counts all requests (32B/request) from the GP Command Processor                        \
        * (CP). It should be equal to the sum of counts returned by                                \
        * <tt>GX_PERF1_FIFO_REQ</tt>, <tt>GX_PERF1_CALL_REQ</tt>, and                              \
        * <tt>GX_PERF1_VC_MISS_REQ</tt>. */
#define GX_PERF1_CLOCKS                                                                            \
    21 /*!< Number of GP clocks that have elapsed since the last call to                           \
          GXReadGP1Metric(). */
 ...
 *
 * \details Each table <tt>GX_TLUT0</tt>-<tt>GX_TLUT15</tt> contains 256
 * entries,16b per entry. <tt>GX_BIGTLUT0</tt>-<tt>3</tt> contains 1024 entries,
...
typedef struct _GXColor {
    ...
    u8 a; /*!< Alpha component. If a function does not use the alpha value, it is
             safely ignored. */
} GXColor;

/*! \typedef struct _GXColorS10 GXColorS10
...
typedef struct _GXColorS10 {
    ...
    s16 a; /*!< Alpha component. If a function does not use the alpha value, it is
              safely ignored. */
} GXColorS10;
 ...
 *
 * \details This structure contains precompiled register state setting commands
 * and data. The application must use the GX_InitTexObj*() function to
 * initialize or change this object. The proper size of the object is returned
 * by
 *
 * \code sizeof(GXTexObj) \endcode
 *
 * \details but the internal data representation is not visible to the
 * application.
 */
 ...
 *
 * \details This structure contains precompiled register state setting commands
 * and data. The application must use the GX_InitTlutObj() function to
 * initialize or change this object. The proper size of the object is returned
 * by
 *
 ...
 *
 * \details This structure contains precompiled register state setting commands
 * and data. The application must use the GX_InitTexCacheRegion() function to
 * initialize or change this object. The proper size of the object is returned
 * by
 *
 ...
 *
 * \details This structure contains precompiled register state setting commands
 * and data. The application must use the GX_InitTlutRegion() function to
 * initialize or change this object. The proper size of the object is returned
 * by
 *
 ...
 *
 * \details This structure contains precompiled register state setting commands
 * and data. The application must use the GX_InitLight*() functions to
 * initialize or change this object. The proper size of the object is returned
 * by
 *
 ...
 *
 * \details An array of these structures can be used to describe all the
 * attributes in a vertex. The attribute <tt>GX_VA_NULL</tt> should be used to
 ...
 *
 * \details An array of these structures can be used to describe the format of
 * all attributes in a vertex. The attribute <tt>GX_VA_NULL</tt> should be used
 ...
 *
 * \details This structure contains precompiled register state setting commands
 * and data. The application must use the GX_InitFifo*() functions to initialize
 * or change this object. The proper size of the object is returned by
 *
...
/*!
\typedef struct _GXRenderModeObj GXRenderModeObj
